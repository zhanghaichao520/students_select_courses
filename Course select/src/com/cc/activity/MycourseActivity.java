...
public class MycourseActivity extends SlidingFragmentActivity implements OnClickListener {
		...
		new AsyncTask<String, Void, String>() {
			...
			protected String doInBackground(String... arg0) {
				...
				try {
					...
					Toast.makeText(MycourseActivity.this, "服务器已断开", Toast.LENGTH_SHORT).show();
					e1.printStackTrace();
				}
				try {
