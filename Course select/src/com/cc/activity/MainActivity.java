...
public class MainActivity extends SlidingFragmentActivity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		student.setSname(bundle.getString("Sname"));
		student.setSno(bundle.getString("Sno"));
		student.setSsex(bundle.getString("Ssex"));
		student.setSage(bundle.getInt("Sage"));
		student.setSgrade(bundle.getString("Sgrade"));
		student.setSphone(bundle.getString("Sphone"));
		student.setDno(bundle.getString("Dno"));
		student.setSpassword(bundle.getString("Spassword"));
		student.setDname(bundle.getString("Dname"));
		student.setFname(bundle.getString("Fname"));
		student.setSphoto(bundle.getString("Sphoto"));
		lv = (ListView) findViewById(R.id.lv);
		readMycourse(Const.URL_MYCOURSE, student.getSno());
	}
	...
	public void readMycourse(String url, String Sno) {
		...
		new AsyncTask<String, Void, String>() {
			...
			protected void onPostExecute(String result) {
				...
				Const.myCourselist = gson.fromJson(result, new TypeToken<List<Course>>() {
				}.getType());
				for (int i = 0; i < Const.myCourselist.size(); i++) {
					Course course = Const.myCourselist.get(i);
					Const.myCourselist.get(i).setCname(Util.ascllToString(course.getCname()));
					Const.myCourselist.get(i).setCgrade(Util.ascllToString(course.getCgrade()));
					Const.myCourselist.get(i).setFname(Util.ascllToString(course.getFname()));
					Const.myCourselist.get(i).setCteacher(Util.ascllToString(course.getCteacher()));
					/*
