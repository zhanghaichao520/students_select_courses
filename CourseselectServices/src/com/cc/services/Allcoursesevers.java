...
/**
 * Servlet implementation class Allcoursesevers
 */
@WebServlet("/Allcoursesevers")
public class Allcoursesevers extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Allcoursesevers() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		grade = Util.ascllToString(grade);
		List<Course> result = new ArrayList<Course>();
		CourseDao op = new CourseDao();
		
		try {
			result = op.queryCourse(grade,dno);
		} catch (Exception e) {
		...
		System.out.println(" allcourse:post----:" + grade+dno);
	}
